...
- [testy/TESTY_ETAP_5.md](testy/TESTY_ETAP_5.md) — pełny silnik, konflikty i korekty,
- [testy/TESTY_ETAP_6.md](testy/TESTY_ETAP_6.md) — plan testów adresów, lokalizacji i tras,
...
`StartRoboczy` ani kursów gruszek. Cały Etap 4, wraz z testem operatora, jest
zakończony. Punkty **5A–5J** i cały Etap 5 również są zakończone; pełny silnik
łączy rzeczywiste starty, pompy, gruszki, limity i konflikty w jednym
...
zapisie wyniku przechodzi **94/94 zestawy testów**.

## Plan Etapu 6 — 2026-09-02

Etap 6 został rozpisany na punkty **6A–6J**. Plan obejmuje kontrakt danych,
adresy z KDX/CSV, punkt węzła, migrację pamięci tras, wybór wymiennego dostawcy,
geokodowanie, trasy węzeł ↔ budowa, przejazdy pomp, interfejs i odporność offline
